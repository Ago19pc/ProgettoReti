...
{
	iki_relocate(dp, "xsim.dir/project_tb_behav/xsim.reloc",  (void **)funcTab, 16);
	iki_vhdl_file_variable_register(dp + 533192);
	iki_vhdl_file_variable_register(dp + 533248);
